...
gmx editconf -f ligand.gro -o ligand_box.gro -c -d 5.0 -bt dodecahedron

gmx grompp -f em.mdp -c ligand_box.gro -p ligand.top -o em.tpr

gmx mdrun -v -deffnm em -s em.tpr -nt 1

gmx grompp -f nvt.mdp -c em.gro -p ligand.top -o nvt.tpr

gmx mdrun -v -deffnm nvt -s nvt.tpr -nt 1
