...
module purge
module load gromacs/2022.1/gcc.8.4.0-openmpi.4.1.2 

echo "Submitting ${ID}"
echo "Job directory: ${SLURM_SUBMIT_DIR}"

mpirun -np 8 gmx_mpi mdrun -ntomp 1 -deffnm prod -replex 200 -multidir $dir/lambda_{0..7}/Production_MD
