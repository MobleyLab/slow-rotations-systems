...
module purge
module load gromacs/2022.1/gcc.8.4.0-cuda.11.7.1.openmpi.4.1.2
...
mpirun -np 12 gmx_mpi mdrun -ntomp 1 -nb gpu -deffnm prod -replex 200 -multidir $dir/lambda_{0..11}/Production_MD
