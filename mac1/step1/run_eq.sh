...
cd $SLURM_SUBMIT_DIR
module purge
module load gromacs/2022.1/gcc.8.4.0

echo "Submitting ${ID}"
echo "Job directory: ${SLURM_SUBMIT_DIR}"


MDP=$dir/MDP/complete_files
...
gmx grompp -f $MDP/em.$LAMBDA.mdp -c $dir/../../complex.gro -r $dir/../../complex.gro -p $dir/../../complex_1_scale.top -o em.tpr -maxwarn 1

gmx mdrun -deffnm em -s em.tpr -ntmpi 1
...
gmx grompp -f $MDP/nvt.$LAMBDA.mdp -c ../EM/em.gro -r $dir/../../complex.gro -p $dir/../../complex_1_scale.top -o nvt.tpr -maxwarn 1

gmx mdrun -deffnm nvt -s nvt.tpr -ntmpi 1

cd ../
mkdir Production_MD
cd Production_MD
gmx grompp -f $MDP/prod.$LAMBDA.mdp -c $dir/lambda_$LAMBDA/NVT/nvt.gro -r $dir/../../complex.gro -p $dir/../../complex_1_scale.top -o prod.tpr -maxwarn 1
