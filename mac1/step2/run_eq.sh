#! /bin/bash
#SBATCH --job-name=16542eq
#SBATCH --partition=free
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --account=ACALDARU
#SBATCH --time=2:00:00
#SBATCH --mem=1gb
#SBATCH --array=0-7
...
gmx grompp -f $MDP/em.$LAMBDA.mdp -c $dir/../../complex.gro -r $dir/../../complex.gro -p $dir/../../complex_2_scale.top -o em.tpr -maxwarn 1
...
gmx grompp -f $MDP/nvt.$LAMBDA.mdp -c ../EM/em.gro -r $dir/../../complex.gro -p $dir/../../complex_2_scale.top -o nvt.tpr -maxwarn 1
...
mkdir Production_MD
cd Production_MD
gmx grompp -f $MDP/prod.$LAMBDA.mdp -c $dir/lambda_$LAMBDA/NVT/nvt.gro -r $dir/../../complex.gro -p $dir/../../complex_2_scale.top -o prod.tpr -maxwarn 1
